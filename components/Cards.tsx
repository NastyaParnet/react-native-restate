...
export const Card = ({
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      className="w-full flex-1 relative mt-4 px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70"
    >
      <View className="flex flex-row items-center absolute px-2 p-1 top-5 right-5 bg-white/90 rounded-full z-50">
